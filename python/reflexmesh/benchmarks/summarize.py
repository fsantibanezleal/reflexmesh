...
def summarize(base: Path, selected: list[str], output: Path) -> dict:
    ...
    report = {
        ...
        "limitations": [
            ...
            "ToolSandbox eight single-tool no-distraction cases and four related tau2 retail variants",
            "Official upstream evaluators used; local model/transport/subset differ from leaderboard protocols",
            "tau2 seed0 original run interrupted after tasks0/1; remaining run independently completed2/3",
            "ToolSandbox preliminary concurrent run had one HTTP500; full isolated rerun retained alongside it",
            "tau2 tasks2/3 have failed action checks despite reward1.0 under DB+COMMUNICATE basis",
